...
public class Constants {
    ...
    /*
    public static final int ACTION_FIND_DESTINATION = 22;
    public static final int ACTION_FOUND_DESTINATION = 23;
    public static final int ACTION_CALCULATE_DISTANCE = 24;
    public static final int ACTION_CALCULATED_DISTANCE = 25;
    public static final int ACTION_START_MOTION = 26;
    public static final int ACTION_STOP_MOTION = 27;
    public static final int ACTION_ASK_FOR_ROAD_AID = 28;
    public static final int ACTION_DESTINATED = 29;
